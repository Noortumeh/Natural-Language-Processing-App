...
var valid = __webpack_require__(/*! valid-url */ "./node_modules/valid-url/index.js");
// check if the url is valid
var isValid = function isValid(url) {
  return Boolean(valid.isWebUri("".concat(url)));
};
...
function handleSubmit(event) {
  ...
  // Check if the URL is valid
  if (!(0,_checkURL__WEBPACK_IMPORTED_MODULE_0__.validateURL)(formText)) {
...
var showError = function showError(msg) {
  ...
  results.innerHTML = "<p class=\"error\">".concat(msg, "</p>");
};
var showResults = function showResults(sample) {
  var results = document.querySelector("#results");
  results.innerHTML = "\n    <p>Agreement: ".concat(sample.agreement, "</p>\n    <p>Subjectivity: ").concat(sample.subjectivity, "</p>\n    <p>Confidence: ").concat(sample.confidence, "</p>\n    <p>Score Tag: ").concat(sample.score_tag, "</p>\n    <p>Irony: ").concat(sample.irony, "</p>\n  ");
};
